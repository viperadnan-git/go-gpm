...
// 	protoc        v3.12.4
// source: .proto/MediaAction.proto
...
func (x *AddMediaToAlbum) Reset() {
	*x = AddMediaToAlbum{}
	mi := &file___proto_MediaAction_proto_msgTypes[0]
...
func (*AddMediaToAlbum) Descriptor() ([]byte, []int) {
	return file___proto_MediaAction_proto_rawDescGZIP(), []int{0}
}
...
func (x *DeleteAlbum) Reset() {
	*x = DeleteAlbum{}
	mi := &file___proto_MediaAction_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteAlbum) Descriptor() ([]byte, []int) {
	return file___proto_MediaAction_proto_rawDescGZIP(), []int{1}
}
...
func (x *AddMediaToAlbum_Field5Type) Reset() {
	*x = AddMediaToAlbum_Field5Type{}
	mi := &file___proto_MediaAction_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddMediaToAlbum_Field5Type) Descriptor() ([]byte, []int) {
	return file___proto_MediaAction_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AddMediaToAlbum_DeviceInfo) Reset() {
	*x = AddMediaToAlbum_DeviceInfo{}
	mi := &file___proto_MediaAction_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddMediaToAlbum_DeviceInfo) Descriptor() ([]byte, []int) {
	return file___proto_MediaAction_proto_rawDescGZIP(), []int{0, 1}
}
...
var File___proto_MediaAction_proto protoreflect.FileDescriptor

const file___proto_MediaAction_proto_rawDesc = "" +
	"\n" +
	"\x18.proto/MediaAction.proto\"\xf7\x02\n" +
...
var (
	file___proto_MediaAction_proto_rawDescOnce sync.Once
	file___proto_MediaAction_proto_rawDescData []byte
)

func file___proto_MediaAction_proto_rawDescGZIP() []byte {
	file___proto_MediaAction_proto_rawDescOnce.Do(func() {
		file___proto_MediaAction_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file___proto_MediaAction_proto_rawDesc), len(file___proto_MediaAction_proto_rawDesc)))
	})
	return file___proto_MediaAction_proto_rawDescData
}

var file___proto_MediaAction_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file___proto_MediaAction_proto_goTypes = []any{
...
var file___proto_MediaAction_proto_depIdxs = []int32{
...
func init() { file___proto_MediaAction_proto_init() }
func file___proto_MediaAction_proto_init() {
	if File___proto_MediaAction_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file___proto_MediaAction_proto_rawDesc), len(file___proto_MediaAction_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file___proto_MediaAction_proto_goTypes,
		DependencyIndexes: file___proto_MediaAction_proto_depIdxs,
		MessageInfos:      file___proto_MediaAction_proto_msgTypes,
	}.Build()
	File___proto_MediaAction_proto = out.File
	file___proto_MediaAction_proto_goTypes = nil
	file___proto_MediaAction_proto_depIdxs = nil
}
