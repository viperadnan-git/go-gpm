...
// 	protoc        v3.12.4
// source: .proto/AlbumAction.proto
...
var File___proto_AlbumAction_proto protoreflect.FileDescriptor
...
var (
	...
	file___proto_AlbumAction_proto_rawDescData []byte
)

func file___proto_AlbumAction_proto_rawDescGZIP() []byte {
	file___proto_AlbumAction_proto_rawDescOnce.Do(func() {
		file___proto_AlbumAction_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file___proto_AlbumAction_proto_rawDesc), len(file___proto_AlbumAction_proto_rawDesc)))
	})
...
func file___proto_AlbumAction_proto_init() {
	if File___proto_AlbumAction_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file___proto_AlbumAction_proto_goTypes,
		DependencyIndexes: file___proto_AlbumAction_proto_depIdxs,
		MessageInfos:      file___proto_AlbumAction_proto_msgTypes,
	}.Build()
	File___proto_AlbumAction_proto = out.File
	file___proto_AlbumAction_proto_goTypes = nil
	file___proto_AlbumAction_proto_depIdxs = nil
}
