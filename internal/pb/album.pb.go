...
// AlbumCreationMode indicates whether album is created with media or empty
type AlbumCreationMode int32

const (
	AlbumCreationMode_ALBUM_CREATION_MODE_UNSPECIFIED AlbumCreationMode = 0
	AlbumCreationMode_WITH_MEDIA                      AlbumCreationMode = 1 // Creating album with media items
	AlbumCreationMode_EMPTY                           AlbumCreationMode = 2 // Creating empty album
)

// Enum value maps for AlbumCreationMode.
var (
	AlbumCreationMode_name = map[int32]string{
		0: "ALBUM_CREATION_MODE_UNSPECIFIED",
		1: "WITH_MEDIA",
		2: "EMPTY",
	}
	AlbumCreationMode_value = map[string]int32{
		"ALBUM_CREATION_MODE_UNSPECIFIED": 0,
		"WITH_MEDIA":                      1,
		"EMPTY":                           2,
	}
)

func (x AlbumCreationMode) Enum() *AlbumCreationMode {
	p := new(AlbumCreationMode)
	*p = x
	return p
}

func (x AlbumCreationMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AlbumCreationMode) Descriptor() protoreflect.EnumDescriptor {
	return file___proto_album_proto_enumTypes[0].Descriptor()
}

func (AlbumCreationMode) Type() protoreflect.EnumType {
	return &file___proto_album_proto_enumTypes[0]
}

func (x AlbumCreationMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AlbumCreationMode.Descriptor instead.
func (AlbumCreationMode) EnumDescriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{0}
}

// CreateAlbum creates a new album with optional media items
type CreateAlbum struct {
	...
	HasMedia      AlbumCreationMode          `protobuf:"varint,3,opt,name=has_media,json=hasMedia,proto3,enum=AlbumCreationMode" json:"has_media,omitempty"`
...
func (x *CreateAlbum) Reset() {
	*x = CreateAlbum{}
	mi := &file___proto_album_proto_msgTypes[0]
...
func (x *CreateAlbum) GetHasMedia() AlbumCreationMode {
	if x != nil {
		return x.HasMedia
	}
	return AlbumCreationMode_ALBUM_CREATION_MODE_UNSPECIFIED
}
...
func (x *CreateAlbumResponse) Reset() {
	*x = CreateAlbumResponse{}
	mi := &file___proto_album_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbumResponse) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{1}
}
...
func (x *AddMediaToAlbum) Reset() {
	*x = AddMediaToAlbum{}
	mi := &file___proto_album_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddMediaToAlbum) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{2}
}
...
func (x *DeleteAlbum) Reset() {
	*x = DeleteAlbum{}
	mi := &file___proto_album_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteAlbum) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*DeleteAlbum) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{3}
}
...
func (x *RenameAlbum) Reset() {
	*x = RenameAlbum{}
	mi := &file___proto_album_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RenameAlbum) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{4}
}
...
func (x *CreateAlbum_MediaKeyRef) Reset() {
	*x = CreateAlbum_MediaKeyRef{}
	mi := &file___proto_album_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbum_MediaKeyRef) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CreateAlbum_Field6Type) Reset() {
	*x = CreateAlbum_Field6Type{}
	mi := &file___proto_album_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbum_Field6Type) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *CreateAlbum_Field7Type) Reset() {
	*x = CreateAlbum_Field7Type{}
	mi := &file___proto_album_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbum_Field7Type) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *CreateAlbum_DeviceInfo) Reset() {
	*x = CreateAlbum_DeviceInfo{}
	mi := &file___proto_album_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbum_DeviceInfo) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *CreateAlbum_MediaKeyRef_MediaKeyInner) Reset() {
	*x = CreateAlbum_MediaKeyRef_MediaKeyInner{}
	mi := &file___proto_album_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbum_MediaKeyRef_MediaKeyInner) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (x *CreateAlbumResponse_Field1Type) Reset() {
	*x = CreateAlbumResponse_Field1Type{}
	mi := &file___proto_album_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAlbumResponse_Field1Type) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *AddMediaToAlbum_Field5Type) Reset() {
	*x = AddMediaToAlbum_Field5Type{}
	mi := &file___proto_album_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddMediaToAlbum_Field5Type) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *AddMediaToAlbum_DeviceInfo) Reset() {
	*x = AddMediaToAlbum_DeviceInfo{}
	mi := &file___proto_album_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddMediaToAlbum_DeviceInfo) Descriptor() ([]byte, []int) {
	return file___proto_album_proto_rawDescGZIP(), []int{2, 1}
}
...
var File___proto_album_proto protoreflect.FileDescriptor

const file___proto_album_proto_rawDesc = "" +
	"\n" +
	"\x12.proto/album.proto\"\xe9\x04\n" +
	"\vCreateAlbum\x12\x1d\n" +
	"\n" +
	"album_name\x18\x01 \x01(\tR\talbumName\x12\x1c\n" +
	"\ttimestamp\x18\x02 \x01(\x03R\ttimestamp\x12/\n" +
	"\thas_media\x18\x03 \x01(\x0e2\x12.AlbumCreationModeR\bhasMedia\x127\n" +
	"\n" +
	...
	"\x06field3\x18\x03 \x01(\x03R\x06field3*S\n" +
	"\x11AlbumCreationMode\x12#\n" +
	"\x1fALBUM_CREATION_MODE_UNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
	"WITH_MEDIA\x10\x01\x12\t\n" +
	"\x05EMPTY\x10\x02B.Z,github.com/viperadnan-git/go-gpm/internal/pbb\x06proto3"

var (
	file___proto_album_proto_rawDescOnce sync.Once
	file___proto_album_proto_rawDescData []byte
)

func file___proto_album_proto_rawDescGZIP() []byte {
	file___proto_album_proto_rawDescOnce.Do(func() {
		file___proto_album_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file___proto_album_proto_rawDesc), len(file___proto_album_proto_rawDesc)))
	})
	return file___proto_album_proto_rawDescData
}

var file___proto_album_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file___proto_album_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file___proto_album_proto_goTypes = []any{
	(AlbumCreationMode)(0),                        // 0: AlbumCreationMode
	(*CreateAlbum)(nil),                           // 1: CreateAlbum
	(*CreateAlbumResponse)(nil),                   // 2: CreateAlbumResponse
	(*AddMediaToAlbum)(nil),                       // 3: AddMediaToAlbum
	(*DeleteAlbum)(nil),                           // 4: DeleteAlbum
	(*RenameAlbum)(nil),                           // 5: RenameAlbum
	(*CreateAlbum_MediaKeyRef)(nil),               // 6: CreateAlbum.MediaKeyRef
	(*CreateAlbum_Field6Type)(nil),                // 7: CreateAlbum.Field6Type
	(*CreateAlbum_Field7Type)(nil),                // 8: CreateAlbum.Field7Type
	(*CreateAlbum_DeviceInfo)(nil),                // 9: CreateAlbum.DeviceInfo
	(*CreateAlbum_MediaKeyRef_MediaKeyInner)(nil), // 10: CreateAlbum.MediaKeyRef.MediaKeyInner
	(*CreateAlbumResponse_Field1Type)(nil),        // 11: CreateAlbumResponse.Field1Type
	(*AddMediaToAlbum_Field5Type)(nil),            // 12: AddMediaToAlbum.Field5Type
	(*AddMediaToAlbum_DeviceInfo)(nil),            // 13: AddMediaToAlbum.DeviceInfo
}
var file___proto_album_proto_depIdxs = []int32{
	0,  // 0: CreateAlbum.has_media:type_name -> AlbumCreationMode
	6,  // 1: CreateAlbum.media_keys:type_name -> CreateAlbum.MediaKeyRef
	7,  // 2: CreateAlbum.field6:type_name -> CreateAlbum.Field6Type
	8,  // 3: CreateAlbum.field7:type_name -> CreateAlbum.Field7Type
	9,  // 4: CreateAlbum.device_info:type_name -> CreateAlbum.DeviceInfo
	11, // 5: CreateAlbumResponse.field1:type_name -> CreateAlbumResponse.Field1Type
	12, // 6: AddMediaToAlbum.field5:type_name -> AddMediaToAlbum.Field5Type
	13, // 7: AddMediaToAlbum.device_info:type_name -> AddMediaToAlbum.DeviceInfo
	10, // 8: CreateAlbum.MediaKeyRef.field1:type_name -> CreateAlbum.MediaKeyRef.MediaKeyInner
...
func init() { file___proto_album_proto_init() }
func file___proto_album_proto_init() {
	if File___proto_album_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file___proto_album_proto_rawDesc), len(file___proto_album_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file___proto_album_proto_goTypes,
		DependencyIndexes: file___proto_album_proto_depIdxs,
		EnumInfos:         file___proto_album_proto_enumTypes,
		MessageInfos:      file___proto_album_proto_msgTypes,
	}.Build()
	File___proto_album_proto = out.File
	file___proto_album_proto_goTypes = nil
	file___proto_album_proto_depIdxs = nil
}
